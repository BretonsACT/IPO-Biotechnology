# 🧬 Multi-Agent System Architecture for Biotech IPO Intelligence `v2.4`
...
> **Hybrid LLM Architecture**: We utilize a hybrid, task-optimized model strategy — pairing high-speed, large-context agents (**Gemini 3.6 Flash**) for web scraping, SEC filing intake, and media audits with deep reasoning models (**Claude Opus 4.6**) for clinical evaluation, financial rNPV modeling, decision-making, and memo compilation.
...
| :--- | :--- | :--- | :--- | :--- |
| [`01_ipo_scanner_agent.md`](file:///home/ACT/Downloads/Biotechnology/agents/01_ipo_scanner_agent.md) | **IPO Scanner** | `Gemini 3.6 Flash` | Filings (S-1), IPO proceeds, Syndicate, Lock-ups | Target list, Gross raise, Lock-up date |
...
| [`04_risk_market_agent.md`](file:///home/ACT/Downloads/Biotechnology/agents/04_risk_market_agent.md) | **Risk & Market Specialist** | `Gemini 3.6 Flash` | TAM, Competition, Patent expiration, FTO, Manufacturing | Risk Matrix Rating & Score |
...
| [`06_media_sentiment_agent.md`](file:///home/ACT/Downloads/Biotechnology/agents/06_media_sentiment_agent.md) | **Media & Sentiment Monitor** | `Gemini 3.6 Flash` | Press (Lancet, BioSpace), Twitter/X, Reddit, Insider trading | Sentiment Score & Bullish/Bearish Ratio |
...
flowchart TD
    ...
    Sub1 -->|Delivers Market Data| Sub4[4. Risk & Market Agent - Gemini 3.6 Flash]
